...
import com.example.movielist.databinding.FragmentPopularMovieBinding
...
class PopularMovie : Fragment() {
    ...
    private fun callApi(page: Int) {
        ...
        api.getPopular(this.page, "bearer ${ApiClient.Token}").enqueue(object : Callback<MovieModal> {
