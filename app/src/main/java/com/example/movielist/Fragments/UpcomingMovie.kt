...
import com.example.movielist.databinding.FragmentUpcomingMovieBinding
...
class UpcomingMovie : Fragment() {
    ...
    private fun callApi(page: Int) {
        ...
        api.getUpcoming(this.page,"bearer ${ApiClient.Token}").enqueue(object : Callback<MovieModal> {
